...
- AI features span more than one surface: MiniMax configuration/client code lives under `Sources/CodeToolCore/Providers/MiniMax/`, while persistence/restore behavior for AI tools lives under `Sources/CodeToolCore/Persistence/`.
