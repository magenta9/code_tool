...
export function Panel({
  ...
  return (
    <div
      className={`rounded-[8px] border border-[var(--ui-border)] bg-[var(--ui-surface)] p-4 shadow-[0_1px_2px_rgba(24,24,22,0.035)] ${className}`}
    >
...
export function ActionButton({
  ...
  const variantClass = {
    neutral:
      "border-[var(--ui-border)] bg-[rgba(25,25,22,0.035)] text-[var(--ui-text)] [@media(hover:hover)]:hover:border-[var(--ui-border-strong)] [@media(hover:hover)]:hover:bg-[rgba(25,25,22,0.06)]",
    primary:
    ...
    danger:
      "border-[var(--ui-border)] bg-[rgba(25,25,22,0.025)] text-[var(--ui-danger)] [@media(hover:hover)]:hover:border-[var(--ui-danger-soft-strong)] [@media(hover:hover)]:hover:bg-[var(--ui-danger-soft)]",
    dangerStrong:
      "border-[var(--ui-danger-soft-strong)] bg-[var(--ui-danger-soft)] text-[var(--ui-danger)] [@media(hover:hover)]:hover:bg-[rgba(185,66,48,0.15)]"
  }[variant];
  const sizeClass = {
...
export function IconButton({
  ...
  const variantClass = {
    neutral:
      "border-transparent bg-transparent text-[var(--ui-text-muted)] [@media(hover:hover)]:hover:border-[var(--ui-border)] [@media(hover:hover)]:hover:bg-[rgba(25,25,22,0.05)] [@media(hover:hover)]:hover:text-[var(--ui-text)]",
    primary:
...
export function SegmentedControl({
  ...
  return (
    ...
    >
      <span
        className="absolute bottom-0.5 top-0.5 z-0 rounded-[6px] bg-[var(--ui-surface)] shadow-[0_1px_2px_rgba(24,24,22,0.08)] transition-transform duration-200 ease-[cubic-bezier(0.2,0.8,0.2,1)]"
        aria-hidden="true"
      ...
      {options.map((option) => (
        <button
          ...
          className={[
            "relative z-10 inline-flex h-[30px] min-w-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-[6px] border-0 bg-transparent px-2.5 text-[12px] font-semibold text-[var(--ui-text-muted)] transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-45",
