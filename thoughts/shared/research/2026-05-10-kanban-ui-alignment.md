...
| 色彩 | 独立暖灰色板，主色为低饱和绿色 `#4f6f5f` | 全局暖米灰 + 棕灰 accent `#756858` | 色相不一致，Kanban 更冷静，其他页面更偏棕 |
...
- Kanban：`--kanban-primary: #4f6f5f`，偏低饱和绿色。
...
| `--app-accent` | 改为或新增 `--app-primary: #4f6f5f` |
| `--app-accent-soft` | 改为 `rgba(79,111,95,0.11)` |
